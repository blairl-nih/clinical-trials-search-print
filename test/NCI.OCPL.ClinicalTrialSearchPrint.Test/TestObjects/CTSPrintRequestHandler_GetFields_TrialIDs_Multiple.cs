...
{
    class CTSPrintRequestHandler_GetFields_TrialIDs_Multiple
        : CTSPrintRequestHandler_GetFields_Base
    {
        public override JObject RequestData =>
            JObject.Parse(@"
{
    ""trial_ids"": [""NCI-2015-01906"", ""NCI-2017-01240"", ""NCI-2015-01906"", ""NCI-2017-01240""],
...
");
        ...
        public override string[] ExpectedTrials => new string[] { "NCI-2015-01906", "NCI-2017-01240", "NCI-2015-01906", "NCI-2017-01240" };
    }
}
