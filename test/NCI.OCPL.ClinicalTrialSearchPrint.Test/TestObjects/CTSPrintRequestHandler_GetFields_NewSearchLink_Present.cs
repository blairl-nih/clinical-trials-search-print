...
{
    class CTSPrintRequestHandler_GetFields_NewSearchLink_Present
...
");
        ...
        public override string ExpectedNewSearchLink => "/about-cancer/treatment/clinical-trials/search/advanced";
    }
}
