...
namespace NCI.Test.Net
{
    ...
    public static class HttpClientMockHelper
    {
        ...
        public static ByteArrayContent CreateResponseBody(string contentType, string responseBody)
        {
            ByteArrayContent body = new ByteArrayContent(Encoding.UTF8.GetBytes(responseBody));
